...
public class TokenUtils {
    ...
    private static FarmerService staticFarmerService;
    ...
    public void setUserService() {
        ...
        staticFarmerService = farmerService;
    }
    ...
    public static Account getCurrentUser() {
        try {
            ...
            if (ObjectUtil.isNotEmpty(token)) {
                ...
                if (RoleEnum.FARMER.name().equals(role)) {
                    return staticFarmerService.selectById(Integer.valueOf(userId));
                }
